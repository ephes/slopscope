...
This directory tracks the public product planning and user-facing documentation for `slopscope`.
...
of this repository. Keep public docs focused on product behavior and generic repository shapes.
