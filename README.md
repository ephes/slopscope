...
This project is not published yet. The repository now contains the initial installable Python package scaffold and a
first `cloc`-backed language summary slice.
...
This repository is in early implementation. The completed slice is intentionally narrow: package metadata, console
scripts, `cloc` availability detection, language-summary CSV parsing, and focused tests. See:
